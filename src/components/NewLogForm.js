            ...
            <section className="new-log-section wrapper-sec">
                ...
                <form onSubmit={this.handleFormSubmit} className="form-new-log">
                    ...
                    <div className="date-partners-input-container">
                        ...
                        <input onChange={this.handleInputChange} type="text" id="partners" placeholder="Joobs" />
                    </div>
                    {/* Practice Outline */}
                    <h3 className="header__outline">Practice Prep</h3>

                    <label htmlFor="topics" className="topics-label">Topics:</label>
                    <input onChange={this.handleInputChange} type="text" className="topics-input" id="topics" placeholder="Swingouts" />

                    <div className="video-container">
                        <label htmlFor="video" className="video-reference-label">Video Reference:</label>
                        <input onChange={this.handleInputChange} type="text" className="video-reference-input" id="video" placeholder="https://www.youtube.com/watch?v=7j61Mi3ATqU" />

                        <label htmlFor="timestamp" className="video-timestamp-label">Timestamp:</label>
                        <input onChange={this.handleInputChange} type="text" className="video-timestamp-input" id="timestamp" placeholder="0m50s" />
                    </div>

                    <label htmlFor="prepNotes" className="outline-notes-label"> Prep Notes:</label>
                    <textarea onChange={this.handleInputChange} className="outline-notes-input" id="prepNotes" placeholder="https://www.youtube.com/watch?v=7j61Mi3ATqU" />
                    {/* Retrospective */}
                    ...
                    <textarea onChange={this.handleInputChange} className="inprogress-input" id="workInProgress" placeholder="Whirly Bird tandem variation" />

                    <label htmlFor="readyForDance" className="ready-label">Ready for the dance floor:</label>
                    <textarea onChange={this.handleInputChange} className="ready-input" id="readyForDance" placeholder="Double Tuck Turn in six counts" />

                    <label htmlFor="newIdeas" className="new-ideas-label">New Ideas:</label>
                    <textarea onChange={this.handleInputChange} className="new-ideas-input" id="newIdeas" placeholder="Incorporate interesting rhythm into the new Swingout variation." />

                    <label htmlFor="partnerLearn" className="partner-learn-label">What I learned from my partner(s):</label>
                    <textarea onChange={this.handleInputChange} className="partner-learn-input" id="partnerLearn" />

                    <label htmlFor="gameNext" className="next-practice-label">Game plan for next practice:</label>
                    <textarea onChange={this.handleInputChange} className="next-practice-input" id="gameNext" />

                    <label htmlFor="retroNotes" className="other-notes-label">Retro Notes:</label>
                    <textarea onChange={this.handleInputChange} className="other-notes-input" id="retroNotes" />
